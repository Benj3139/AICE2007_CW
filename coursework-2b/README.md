# CW2b: Oat v.2 -- Typechecking Structs, Function Pointers, and Subtyping
...
clang instead of the AICE2007 backend, which can be useful for testing
purposes.
...
Run the test case cw2aprograms/fact.oat using the 341 backend:

          ./oatc --execute-x86 cw2arograms/fact.oat bin/runtime.c 
          120--------------------------------------------------------------- Executing: a.out
          * a.out returned 0
